...
public class ConfigFileListTest
{
    ...
    public void serializationTest() throws IOException
    {
        ...
        Assert.assertEquals(3, deserialized.getTestingConfig().size());
        Assert.assertEquals(3, deserialized.getDevelopmentConfig().size());
        Assert.assertEquals(3, deserialized.getProductionConfig().size());
    }
}
